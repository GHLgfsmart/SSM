package com.ht.controller.weixin;
...
import com.ht.service.weixin.ImgmsgService;
import com.ht.service.weixin.TextmsgService;
...
public class TextmsgController extends BaseController {
	...
	public Object hasK(){
		...
		try{
			pd = this.getPageData();
			pd.put("STATUS", "3");
			if(textmsgService.findByKw(pd) != null || imgmsgService.findByKw(pd) != null){
				errInfo = "error";
			}
		} catch(Exception e){
			logger.error(e.toString(), e);

...
public class Checkout {
	...
	private int OUT_PUT_TYPE;//检测单类型（关联out_put_type（出入库类型表））
	...
	public Checkout(String iD, String sOURCECODE, String tIME, int oUT_PUT_TYPE, int qUANTITY, int dAMAGEDQTY,
	...
	public int getOUT_PUT_TYPE() {
		return OUT_PUT_TYPE;
	}

	public void setOUT_PUT_TYPE(int oUT_PUT_TYPE) {
		OUT_PUT_TYPE = oUT_PUT_TYPE;
	}

...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="categories/list.do?" method="post" name="Form" id="Form">
								...
								<td>
									<div class="nav-search">
										<span class="input-icon">
											...
											id="keywords" name="keywords" autocomplete="off" value="${page.pd.keywords }" />
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>
												<a href="javascript:" onclick="goSondict('${var.ID }')">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									...
									<a class="btn btn-sm btn-success" onclick="goSondict('${pd.UID}')">返回</a>
									</c:if>
								</td>
								<td style="vertical-align:top;">
	...
	<script type="text/javascript">
		...
		function goSondict(ID){
			top.jzts();
			window.location.href="<%=basePath%>categories/list.do?ID="+ID;
		};

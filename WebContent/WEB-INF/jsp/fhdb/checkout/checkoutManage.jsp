			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="warehousing/findcheckListAll.do" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">检测单类型</th>
									<th class="center">总数量</th>
									<th class="center">坏货数量</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.SOURCECODE}</td>
											<td class='center'>${var.OPTNAME}</td>
											<td class='center'>${var.QUANTITY}</td>
											<td class='center'>${var.DAMAGEDQTY}</td>
...
function edit(Id){
	 ...
	 diag.Drag=true;
	 diag.Title ="编辑";
	 diag.URL = '<%=basePath%>warehousing/checkoutEditPage.do?ID='+Id;
	 diag.Width = 850;
	 diag.Height = 500;

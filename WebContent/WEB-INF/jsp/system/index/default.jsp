...
<body class="gray-bg" style="background-color: white;" >
		<form action="<%=basePath%>login_default.do" method="post" id="defaultForm" name="defaultForm">
            <div class="ibox float-e-margins" style="width: 60%;height:500px;float: left;margin-top: 12px;border:7px #E7EAEC solid;margin-left: 12px;">
                <div class="ibox-title">
                    <h5 style="color: #438EB9;">-------天气-------</h5>
                    <div class="ibox-tools">
                        <a class="collapse-link" onclick="resh();">
                            <i class="fa fa-refresh"></i>
                        </a>
                    </div>
                </div>

                <div class="ibox-content timeline" style="height:200px;margin-top:20px;">
                    <div class="timeline-item" style=";margin-top:80px;">
                        <div class="row" style="height:200px">
                        	<div align="center" style="height:100%">
						       <iframe width="100%" scrolling="no" height="100%" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=19&icon=1&temp=1&num=5"></iframe>
						    </div>
                        </div>
                    </div>
                </div>

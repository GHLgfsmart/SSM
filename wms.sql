...
CREATE TABLE `checkout` (
  ...
  `SOURCECODE` varchar(20) DEFAULT NULL,
  `TIME` varchar(30) DEFAULT NULL,
  `OUTPUT_TYPE_ID` varchar(50) DEFAULT NULL,
  `QUANTITY` int(11) DEFAULT NULL,
  `DAMAGEDQTY` int(11) DEFAULT NULL,
  `DAMAGEDREASON` varchar(100) DEFAULT NULL,
  `SHORTQTY` int(11) DEFAULT NULL,
  `SHORTREASON` varchar(100) DEFAULT NULL,
  `INSPECTOR` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `check_outpuid_fk` (`OUTPUT_TYPE_ID`),
  CONSTRAINT `check_outpuid_fk` FOREIGN KEY (`OUTPUT_TYPE_ID`) REFERENCES `output_type` (`ID`)
...
CREATE TABLE `drawing` (
  ...
  `JINGSHUO_ID` varchar(50) DEFAULT NULL,
  `DRAWING_INST` varchar(50) DEFAULT NULL,
  `STATE` int(11) DEFAULT '0',
  `MATERIALS_ID` varchar(50) DEFAULT NULL,
  `WAREHOUSE_OUT_ID` varchar(50) DEFAULT NULL,
  `WAREHOUSE_PUT_ID` varchar(50) DEFAULT NULL,
  `INSPECTOR` varchar(20) DEFAULT NULL,
  ...
  `ZHAIYAO_INST` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `dra_uid_fk` (`JINGSHUO_ID`),
  KEY `dra_waro_fk` (`WAREHOUSE_OUT_ID`),
  KEY `dra_warp_fk` (`WAREHOUSE_PUT_ID`),
  KEY `dra_mat_fk` (`MATERIALS_ID`),
  CONSTRAINT `dra_mat_fk` FOREIGN KEY (`MATERIALS_ID`) REFERENCES `materials_information` (`ID`),
  CONSTRAINT `dra_uid_fk` FOREIGN KEY (`JINGSHUO_ID`) REFERENCES `sys_user` (`USER_ID`),
  CONSTRAINT `dra_waro_fk` FOREIGN KEY (`WAREHOUSE_OUT_ID`) REFERENCES `warehouse` (`ID`),
  CONSTRAINT `dra_warp_fk` FOREIGN KEY (`WAREHOUSE_PUT_ID`) REFERENCES `warehouse` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `inventory` (
  ...
  `ENTRY_TIME` varchar(30) DEFAULT NULL,
  `UPDATE_TIME` varchar(30) DEFAULT NULL,
  `PANDIAN_INST` varchar(100) DEFAULT NULL,
  `ZHAIYAO_INST` varchar(100) DEFAULT NULL,
  `PRACTICAL` int(11) DEFAULT NULL,
  `DECREASE_COUNT` int(11) DEFAULT NULL,
  `NOTE` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `inv_uid_fk` (`JINGSHUO_ID`),
  KEY `inv_matid_fk` (`MATERIALS_ID`),
  KEY `inv_warid_fk` (`WAREHOUSE_ID`),
  CONSTRAINT `inv_matid_fk` FOREIGN KEY (`MATERIALS_ID`) REFERENCES `materials_information` (`ID`),
  CONSTRAINT `inv_uid_fk` FOREIGN KEY (`JINGSHUO_ID`) REFERENCES `sys_user` (`USER_ID`),
  CONSTRAINT `inv_warid_fk` FOREIGN KEY (`WAREHOUSE_ID`) REFERENCES `warehouse` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for materials_information
-- ----------------------------
DROP TABLE IF EXISTS `materials_information`;
CREATE TABLE `materials_information` (
  `ID` varchar(50) NOT NULL,
  `BIANHAO` varchar(20) DEFAULT NULL,
  ...
  `STATE` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `mat_cusid_fk` (`CUS_ID`),
  CONSTRAINT `mat_cusid_fk` FOREIGN KEY (`CUS_ID`) REFERENCES `supplier_customer` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of materials_information
-- ----------------------------
...
INSERT INTO `oa_department` VALUES ('5cccdb7c432449d8b853c52880058140', '仓库', 'b', '002', '0', '冶铁', '李四', '112', '冶铁', '河北');
INSERT INTO `oa_department` VALUES ('a6c6695217ba4a4dbfe9f7e9d2c06730', '市场部', 'a', '001', '0', '挖煤', '张三', '110', '洼煤矿', '山西');
...
INSERT INTO `oa_department` VALUES ('febe501517114e50891977e41cf3649d', '2', '2', '2', '0', '2', '2', '2', '2', '2');

-- ----------------------------
-- Table structure for output_storage
-- ----------------------------
DROP TABLE IF EXISTS `output_storage`;
CREATE TABLE `output_storage` (
  ...
  `ENTRY_TIME` varchar(30) DEFAULT NULL,
  `UPDATE_TIME` varchar(30) DEFAULT NULL,
  `raw_number` varchar(20) DEFAULT NULL,
  `RETURNFLAG` varchar(10) DEFAULT NULL,
  `RETURN_COUNT` int(11) DEFAULT NULL,
  `NOTE` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `stor_matid_fk` (`MATERIALS_ID`),
  KEY `stor_warid_fk` (`WAREHOUSE_ID`),
  KEY `stor_outpuid_fk` (`OUTPUT_TYPE_ID`),
  KEY `stor_userid_fk` (`USER_ID`),
  CONSTRAINT `stor_matid_fk` FOREIGN KEY (`MATERIALS_ID`) REFERENCES `materials_information` (`ID`),
  CONSTRAINT `stor_outpuid_fk` FOREIGN KEY (`OUTPUT_TYPE_ID`) REFERENCES `output_type` (`ID`),
  CONSTRAINT `stor_userid_fk` FOREIGN KEY (`USER_ID`) REFERENCES `sys_user` (`USER_ID`),
  CONSTRAINT `stor_warid_fk` FOREIGN KEY (`WAREHOUSE_ID`) REFERENCES `warehouse` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of output_storage
-- ----------------------------
...
CREATE TABLE `sales_return` (
  `ID` varchar(50) NOT NULL,
  `RETREAT_CODE` varchar(20) DEFAULT NULL,
  `OUT_CODE` varchar(20) DEFAULT NULL,
  `INSPECTOR` varchar(20) DEFAULT NULL,
  `WAREHOUSE_OUT_ID` varchar(50) DEFAULT NULL,
  `WAREHOUSE_PUT_ID` varchar(50) DEFAULT NULL,
  `MAKETIME` varchar(30) DEFAULT NULL,
  `COUNT` int(11) DEFAULT NULL,
  `NOTE` varchar(100) DEFAULT NULL,
  `STATE` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `sal_warout_fk` (`WAREHOUSE_OUT_ID`),
  KEY `sal_warput_fk` (`WAREHOUSE_PUT_ID`),
  CONSTRAINT `sal_warout_fk` FOREIGN KEY (`WAREHOUSE_OUT_ID`) REFERENCES `warehouse` (`ID`),
  CONSTRAINT `sal_warput_fk` FOREIGN KEY (`WAREHOUSE_PUT_ID`) REFERENCES `warehouse` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for supplier_customer
-- ----------------------------
...
CREATE TABLE `supplier_customer` (
  ...
  `OPEN_ACCOUNT` varchar(20) DEFAULT NULL,
  `SITE_ADDRESS` varchar(30) DEFAULT NULL,
  `BANK` varchar(19) DEFAULT NULL,
  `EIN` varchar(30) DEFAULT NULL,
  `NOTE` varchar(50) DEFAULT NULL,
  `STATE` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `cus_cat_id` (`CATEGORIES_ID`),
  KEY `cus_uid_fk` (`USER_ID`),
  CONSTRAINT `cus_cat_id` FOREIGN KEY (`CATEGORIES_ID`) REFERENCES `customer_categories` (`ID`),
  CONSTRAINT `cus_uid_fk` FOREIGN KEY (`USER_ID`) REFERENCES `sys_user` (`USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of supplier_customer
-- ----------------------------
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', '系统管理', '#', '0', '8', 'menu-icon fa fa-cog black', '2', '1');
INSERT INTO `sys_menu` VALUES ('2', '权限管理', '#', '1', '1', 'menu-icon fa fa-lock black', '1', '1');
INSERT INTO `sys_menu` VALUES ('3', '出库管理', '#', '0', '5', 'menu-icon fa fa-comments purple', '2', '1');
INSERT INTO `sys_menu` VALUES ('6', '信息管理', '#', '0', '3', 'menu-icon fa fa-credit-card green', '2', '1');
INSERT INTO `sys_menu` VALUES ('7', '邮件管理', '#', '6', '1', 'menu-icon fa fa-folder-o pink', '2', '1');
INSERT INTO `sys_menu` VALUES ('8', '库存报表', '#', '9', '8', 'menu-icon fa fa-tachometer red', '1', '1');
INSERT INTO `sys_menu` VALUES ('9', '数据统计分析', '#', '0', '7', 'menu-icon fa fa-desktop blue', '2', '1');
INSERT INTO `sys_menu` VALUES ('10', '入库计划单差异报表', 'tool/interfaceTest.do', '9', '2', 'menu-icon fa fa-exchange green', '1', '1');
INSERT INTO `sys_menu` VALUES ('11', '出库报表', '#', '9', '3', 'menu-icon fa fa-envelope-o green', '1', '1');
INSERT INTO `sys_menu` VALUES ('12', '实际出库报表', '#', '9', '4', 'menu-icon fa fa-barcode green', '1', '1');
INSERT INTO `sys_menu` VALUES ('14', '库内运作报表', '#', '9', '6', 'menu-icon fa fa-globe black', '1', '1');
INSERT INTO `sys_menu` VALUES ('15', '入库管理', '#', '0', '4', 'menu-icon fa fa-comments purple', '2', '1');
INSERT INTO `sys_menu` VALUES ('16', '入库', '#', '15', '2', 'menu-icon fa fa-comment green', '2', '1');
INSERT INTO `sys_menu` VALUES ('17', '货物摆放', '#', '15', '4', 'menu-icon fa fa-comment grey', '2', '1');
INSERT INTO `sys_menu` VALUES ('18', '收货管理', '#', '15', '3', 'menu-icon fa fa-comment pink', '2', '1');
INSERT INTO `sys_menu` VALUES ('19', '物资信息', '#', '15', '1', 'menu-icon fa fa-comment orange', '2', '1');
INSERT INTO `sys_menu` VALUES ('20', '退货入库', '#', '15', '5', 'menu-icon fa fa-laptop green', '1', '1');
INSERT INTO `sys_menu` VALUES ('21', '盘点差异报表', '#', '9', '7', 'menu-icon fa fa-hdd-o grey', '1', '1');
INSERT INTO `sys_menu` VALUES ('22', '出库管理', '#', '0', '5', 'menu-icon fa fa-fire orange', '2', '1');
INSERT INTO `sys_menu` VALUES ('23', '出库计划', '#', '22', '1', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('24', '拣货管理', '#', '22', '2', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('30', '越货', '#', '22', '3', 'menu-icon fa fa-leaf black', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('34', '供应商分类', '#', '40', '3', 'menu-icon fa fa-leaf black', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('38', '在线管理', 'onlinemanager/list.do', '1', '3', 'menu-icon fa fa-laptop green', '1', '1');
INSERT INTO `sys_menu` VALUES ('39', '按钮管理', 'fhbutton/list.do', '1', '2', 'menu-icon fa fa-download orange', '1', '1');
INSERT INTO `sys_menu` VALUES ('40', '基本资料', '#', '0', '1', 'menu-icon fa fa-users blue', '2', '1');
INSERT INTO `sys_menu` VALUES ('41', '部门管理', 'department/listAllDepartment.do?DEPARTMENT_ID=0', '40', '1', 'menu-icon fa fa-users green', '1', '1');
INSERT INTO `sys_menu` VALUES ('42', '用户管理', 'user/listUsers.do', '40', '2', 'menu-icon fa fa-users orange', '1', '1');
INSERT INTO `sys_menu` VALUES ('43', '备份定时器', 'timingbackup/list.do', '1', '4', 'menu-icon fa fa-book purple', '1', '1');
INSERT INTO `sys_menu` VALUES ('44', '入库计划报表', 'createCode/list.do', '9', '0', 'menu-icon fa fa-cogs brown', '1', '1');
INSERT INTO `sys_menu` VALUES ('45', '供应商信息', '#', '40', '4', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('46', '仓库设置', '#', '40', '5', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('47', '出入库类型', 'login_default.do', '40', '6', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('48', '发货差异报表', ' #', '9', '5', 'menu-icon fa fa-bar-chart-o black', '1', '1');
INSERT INTO `sys_menu` VALUES ('50', '站内信', 'fhsms/list.do', '6', '2', 'menu-icon fa fa-envelope green', '1', '1');
INSERT INTO `sys_menu` VALUES ('51', '发送邮件', 'tool/goSendEmail.do', '7', '1', 'menu-icon fa fa-tachometer blue', '1', '1');
INSERT INTO `sys_menu` VALUES ('52', '查看邮件', 'pictures/goImageCrawler.do', '7', '2', 'menu-icon fa fa-cloud-download green', '1', '1');
INSERT INTO `sys_menu` VALUES ('53', '实际收货报表', 'tool/goFormbuilder.do', '9', '1', 'menu-icon fa fa-leaf black', '1', '1');
INSERT INTO `sys_menu` VALUES ('54', '仓库管理', '#', '0', '6', 'menu-icon fa fa-hdd-o blue', '2', '1');
INSERT INTO `sys_menu` VALUES ('55', '库存报警', '#', '54', '1', 'menu-icon fa fa-cloud-upload blue', '1', '1');
INSERT INTO `sys_menu` VALUES ('56', '库存盘点', '#', '54', '3', 'menu-icon fa fa-cloud-download blue', '1', '1');
INSERT INTO `sys_menu` VALUES ('57', '仓库调拨', '#', '54', '2', 'menu-icon fa fa-tachometer blue', '1', '1');
INSERT INTO `sys_menu` VALUES ('58', '查看库存', '#', '54', '4', 'menu-icon fa fa-pencil-square-o blue', '1', '1');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '系统管理组', '2305280058220076998', '0', '1', '1', '1', '1');
INSERT INTO `sys_role` VALUES ('115b386ff04f4352b060dffcd2b5d1da', '保管员', '498', '2', '0', '0', '0', '0');
INSERT INTO `sys_role` VALUES ('1b67fc82ce89457a8347ae53e43a347e', '理货员', '498', '2', '0', '0', '0', '0');
INSERT INTO `sys_role` VALUES ('2', '仓库管理组', '498', '0', '0', '0', '0', '1');
INSERT INTO `sys_role` VALUES ('3264c8e83d0248bb9e3ea6195b4c0216', '一级管理员', '4611123067433770950', '1', '1688848820068294', '2251798773489606', '1125898866646982', '560135202614009798');
INSERT INTO `sys_role` VALUES ('68f8e4a39efe47c7bb869e9d15ab925d', '二级管理员', '9323789887233798', '1', '0', '0', '2251798773489606', '0');
INSERT INTO `sys_role` VALUES ('6ea2247bcfaa41b5ace91032056e2725', '仓库主管', '498', '2', '0', '0', '0', '0');
INSERT INTO `sys_role` VALUES ('8b70a7e67f2841e7aaba8a4d92e5ff6f', '记帐员', '498', '2', '0', '0', '0', '0');
INSERT INTO `sys_role` VALUES ('de9de2f006e145a29d52dfadda295353', '三级管理员', '2305280058220076998', '1', '0', '0', '0', '0');
...
CREATE TABLE `sys_user` (
  ...
  `FAILURE_NUM` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', 'FH', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2016-12-14 10:41:18', '0:0:0:0:0:0:0:1', '0', 'admin', 'default', 'QQ313596790@main.com', '001', '18788888888', null);
INSERT INTO `sys_user` VALUES ('981fc06382ab4985b0b22be72c476027', '小明', '5ae6df594866af497e8afe9b1168099d9debe141', '黄晓明', '', '68f8e4a39efe47c7bb869e9d15ab925d', '2016-12-11 09:53:42', '0:0:0:0:0:0:0:1', '0', '3', 'default', '3@qq.com', '0002', '13125383725', null);
...
CREATE TABLE `warehouse` (
  ...
  `STATE` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `w_uid_pk` (`USER_ID`),
  CONSTRAINT `w_uid_pk` FOREIGN KEY (`USER_ID`) REFERENCES `sys_user` (`USER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
